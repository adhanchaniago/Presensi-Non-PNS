                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nik" id="nik" value="<?= $user->nik ?>" class="form-control" placeholder="Masukan NIK Karyawan" />
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="divisi" id="divisi" value="<?= $user->divisi ?>" class="form-control">
                                        ...
                                        <?php foreach($divisi as $d): ?>
                                            <option value="<?= $dx->id_divisi ?>" <?= ($d->id_divisi == $user->divisi) ? 'selected' : '' ?>><?= $d->nama_divisi ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
