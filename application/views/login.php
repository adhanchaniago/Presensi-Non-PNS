...
<head>
    ...
    <link rel="icon" type="image/ico" sizes="16x16" href="<?php echo base_url(); ?>assets/img/logo_bppt.png">
    <title>Absen Pusyantek </title>
                    ...
                    <section id="login-body" class="pt-3">
                        <div class="card border-0 shadow pt-3">
                            <div class="card-header bg-transparent border-bottom-0 pb-0 text-center">
                                <img src="<?= base_url('assets/img/logo2.png') ?>" alt="Logo Pusyantek BPPT" class="img-fluid mx-auto d-block">
                                <div class="mt-3">
